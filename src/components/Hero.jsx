...
const HeroData = [
  {
    ...
    title: "Orange Fanta",
    subtitle:
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad atque tempora id dolores, harum quam perferendis itaque assumenda laborum illo cum doloribus",
    price: "$40",
    modal: "Orange",
    bgColor: "#cf4f00",
  },
    ...
    <>
      ...
      >
        ...
        <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[605px]">
          ...
          <div className="text-white/5 text-[300px] font-poppins font-extrabold absolute top-34 left-[66%] -translate-x-1/2 -translate-y-1/2">
            {activeData.modal}
          </div>
          {/* Whatsapp icon */}
